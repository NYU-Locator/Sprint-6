...
//    @SuppressWarnings("null")
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,  
		...
		openDB();
		myDB.insertRow(2014, "Dec", 16, "PM", "6", "30", "Maroon 5 Live @ Brooklyn", "MUSIC", 2, "630 Atlantic Ave, Brooklyn, NY 11217", "Brooklyn", 1, 40.682769, -73.974702, "Maroon 5 just comes to Brooklyn!", 0, "NULL", 2, "dfger");
...
//		populateListViewFromDB();
 ...
 //           	TextView m = (TextView) rootView.findViewById(R.id.event_m1);
            	...
            	bundle.putString("key_lat", lat_reading);
            	bundle.putString("key_lng", lng_reading);
